    ...
    <div>
      <div className="d-none d-lg-block">
        ...
        <div className="row g-0">
          <div className="col-4 col-md-4 container d-flex jusfity-content-center align-items-center">
            <div className="ml-2">
              ...
              <p className="lead">
                ...
                book selection and our book selection are always going to be our
                top priority.
              </p>
            </div>
          </div>
        ...
        <div className="container">
          <div className="m-2">
            ...
            <div className="m-2">
              ...
              <p className="lead">
                The library team would love to know what you have been reading.
                Whether is is to learn a new skill or grow within one, we will
                be able to provide the top content for you!
              </p>
              <a className="btn main-color btn-lg text-white" href="#">
                Sign up
